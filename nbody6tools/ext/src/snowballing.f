     ...
     &                            CLSTARS(CL,:),NIN,NBOUND,RAD,SCREEN)

      END DO
      CALL SB_SIME(NSTARS,NCL,STARS,RMAX,CLSTARS,RTOCL,SCREEN,TOL)
...
80    CONTINUE
     ...
     & R,SCREEN,TOL)
      ...
      DOUBLE PRECISION R(NCL,NPART)
      LOGICAL SCREEN

      INTEGER I,J,BMIN,L,ITERFLAG,NBOUND(NCL),NBOUNDOLD(NCL),CL
      INTEGER ITERMAX,TOL
      DOUBLE PRECISION SEP,KE,POT,IVEL(4,NPART),G
